...
public interface IDimension {
    ...
    /**
     * Set the engine assigned dimension ID. YOU SHOULD STORE THIS FOR RETRIEVAL THROUGH {@link IDimension#getAssignedDimensionID()}
     *
    ...
    /**
     * @param dimensionID the dimension to query
